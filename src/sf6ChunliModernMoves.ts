...
export const SF6_CHUNLI_MODERN_DATA_META = {
  gameId: 'sf6',
...
const RAW_MOVES = [
  ...
  {
    "name": "←溜め+アシスト+必(←溜め→+攻撃+攻撃)（OD 気功拳）",
    "category": "special",
    "totalFrames": 39,
    "startupFrames": 11,
    "activeStartFrames": null,
    "activeFrames": null,
    "memo": "公式カテゴリ: 必殺技\n公式コマンド: ←溜め+アシスト+必(←溜め→+攻撃+攻撃)\n公式発生: 11\n公式持続: -\n硬直: 全体 39\nヒット: 5\nガード: 0\nキャンセル: SA2\nダメージ: 640\n(800)\nコンボ補正: 始動補正20%\nDゲージ増加（ヒット）: 0\nDゲージ減少（ガード）: -2500\nDゲージ減少（パニッシュ）: -5000\nSAゲージ増加: 400\n属性: 上・弾",
    "enabled": true
  },
  {
    "name": "N+必(↓↘→+弱)（弱 百裂脚）",
  ...
  {
    "name": "（OD百裂脚後に）必(攻撃+攻撃)（百裂連脚）",
    "category": "special",
    "totalFrames": 71,
    "startupFrames": 11,
    "activeStartFrames": 46,
    "activeFrames": 46,
    "memo": "公式カテゴリ: 必殺技\n公式コマンド: （OD百裂脚後に）必(攻撃+攻撃)\n公式発生: 11\n公式持続: 11- 46\n持続詳細: 11-12, 18-19, 24-25, 31-32, 46\n硬直: 25\nヒット: D\nガード: -13\nダメージ: 700\nDゲージ増加（ヒット）: 0\nDゲージ減少（ガード）: -5000\nDゲージ減少（パニッシュ）: -5000\nSAゲージ増加: 500\n属性: 上",
    "enabled": true
  },
  {
    "name": "↓溜め↑+弱（弱 スピニングバードキック）",
    "category": "special",
    "totalFrames": null,
    "startupFrames": 9,
  ...
  {
    "name": "（体力25%以下で）↓+必+強(↓↙←↓↙←+強)（CA 蒼天乱華）",
    "category": "super",
    "totalFrames": 82,
    "startupFrames": 8,
    "activeStartFrames": 42,
    "activeFrames": 42,
    "memo": "公式カテゴリ: スーパーアーツ\n公式コマンド: （体力25%以下で）↓+必+強(↓↙←↓↙←+強)\n公式発生: 8\n公式持続: 8-42\n持続詳細: 8-9, 34,42\n硬直: 40\nヒット: D\nガード: -24\nダメージ: 3600\n(4500)\nコンボ補正: ※即時補正10％\nDゲージ増加（ヒット）: 0\nDゲージ減少（ガード）: -10000\nDゲージ減少（パニッシュ）: -20000\nSAゲージ増加: 0\n属性: 上\nフレーム補足: 1-9F\n備考: 1-9F　完全無敵\n最低保障ダメージ50％\nカウンター/パニッシュカウンターで数値が変動しない\n※必殺技キャンセル時のみ適用",
    "enabled": true
  },
  {
    "name": "（近距離で）N or →+弱+中（虎襲倒）",
    "category": "common",
    "totalFrames": 30,
    "startupFrames": 5,
    "activeStartFrames": 5,
    "activeFrames": 7,
    "memo": "公式カテゴリ: 通常投げ\n公式コマンド: （近距離で）N or →+弱+中\n公式発生: 5\n公式持続: 5-7\n硬直: 23\nヒット: D\nダメージ: 1200\nコンボ補正: 即時補正20%\nDゲージ増加（ヒット）: 2000\nDゲージ減少（ガード）: 0\nDゲージ減少（パニッシュ）: -10000\nSAゲージ増加: 2000\n属性: 投\n備考: パニッシュカウンター時以下の性能変化\n・ダメージ2040\n・SAゲージ4000増加\n・ハードノックダウン",
    "enabled": true
  },
  {
    "name": "（近距離で）←+弱+中（太極扇）",
  ...
  {
    "name": "（ガード中 or ドライブパリィ成立中に）→+（[ガード時]ドライブリバーサル（鳳翼脚））",
    "category": "common",
    "totalFrames": 61,
    "startupFrames": 20,
    "activeStartFrames": 33,
    "activeFrames": 35,
    "memo": "公式カテゴリ: 共通システム\n公式コマンド: （ガード中 or ドライブパリィ成立中に）→+\n公式発生: 20\n公式持続: 20-35\n持続詳細: 20-22, 33-35\n硬直: 26\nヒット: D\nガード: -6\nダメージ: 500\nDゲージ増加（ヒット）: 0\nDゲージ減少（ガード）: 0\nDゲージ減少（パニッシュ）: 0\nSAゲージ増加: 0\n属性: 上\nフレーム補足: 1-22F / ヒット時硬直が7F増加\n備考: リカバリアブルダメージ\n1-22F　完全無敵\nヒット時硬直が7F増加",
    "enabled": true
  },
  {
    "name": "（起き上がり時に）→+（[起き上がり時]ドライブリバーサル（鳳翼脚））",
    "category": "common",
    "totalFrames": 59,
    "startupFrames": 18,
    "activeStartFrames": 31,
  ...
  {
    "name": "（必殺技キャンセル可能な攻撃ヒット中に）→→ or (N or →)+（キャンセルドライブラッシュ）",
    "category": "common",
    "totalFrames": 46,
    "startupFrames": null,
    "activeStartFrames": null,
    "activeFrames": null,
    "memo": "公式カテゴリ: 共通システム\n公式コマンド: （必殺技キャンセル可能な攻撃ヒット中に）→→ or (N or →)+\n公式発生: -\n公式持続: -\n硬直: 全体 46\nキャンセル: ※\nダメージ: 0\nコンボ補正: 乗算補正15％\nDゲージ増加（ヒット）: 0\nDゲージ減少（ガード）: 0\nDゲージ減少（パニッシュ）: 0\nSAゲージ増加: 0\nフレーム補足: 暗転9F / ※動作10F目から攻撃行動にキャンセル可 / 25F目からパリィ以外の行動でキャンセル可\n備考: 暗転9F\n※動作10F目から攻撃行動にキャンセル可\n　25F目からパリィ以外の行動でキャンセル可",
    "enabled": true
  }
];

export const SF6_CHUNLI_MODERN_MOVES = RAW_MOVES as SeedMove[];
